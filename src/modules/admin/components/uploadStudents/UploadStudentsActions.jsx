...
const UploadStudentsActions = ({ studentsCount, isSubmitting, onCancel, onSubmit }) => {
  return (
      <div className="flex flex-col sm:flex-row gap-3 justify-end">
        ...
        <button
          onClick={onSubmit}
          disabled={isSubmitting || studentsCount === 0}
...
export default UploadStudentsActions;