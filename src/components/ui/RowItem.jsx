...
const RowItem = ({ columns, status, onStatusChange, editable = true, showStatus = true, onClick }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center bg-gray-100 p-3 sm:p-4 rounded-md mb-2 gap-3 sm:gap-4 cursor-pointer hover:bg-gray-200 transition-colors" onClick={onClick}>
