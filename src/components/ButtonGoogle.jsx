...
const ButtonGoogle = ({ onClick, text = "Continue with Google" }) => {
  return (
    <button
      onClick={onClick}
      className="flex items-center justify-center gap-3 px-5 py-2.5 rounded-full border border-gray-300 bg-white text-gray-700 font-medium shadow-sm hover:bg-gray-100 active:scale-95 transition-all duration-150"
    >
